-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc_16\hdlcoderfftdit\HDL_FFT.vhd
...
ARCHITECTURE rtl OF HDL_FFT IS
  ...
  -- Signals
  SIGNAL twindex                          : std_logic_vector(3 DOWNTO 0);  -- ufix4
  ...
  SIGNAL waddrm2                          : std_logic_vector(2 DOWNTO 0);  -- ufix3
  SIGNAL m2wr_en                          : std_logic;
  SIGNAL addrbf                           : std_logic_vector(2 DOWNTO 0);  -- ufix3
  ...
  SIGNAL waddrm1                          : std_logic_vector(2 DOWNTO 0);  -- ufix3
...
BEGIN
  ...
  u_FFTLogic0 : FFTLogic
    PORT MAP( clk => clk,
              ...
              waddrm1 => waddrm1,  -- ufix3
              waddrm2 => waddrm2,  -- ufix3
              m1b1wr_en => m1b1wr_en,
              m1b2wr_en => m1b2wr_en,
              m2wr_en => m2wr_en,
              addrbf => addrbf,  -- ufix3
